        ...
        <div class="col-sm-12">
          <div class="card-box table-responsive">
            ...
            <!-- DETAIL LAPORAN -->
              ...
              ?>
                <div id="detail-<?php echo $v->id_cetak; ?>" class="modal fade bs-example-modal-lg-<?php echo $v->id_cetak; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
