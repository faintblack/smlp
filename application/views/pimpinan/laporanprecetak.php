  ...
  <div class="content">
    <div class="container">
      ...
      <ol class="breadcrumb" style="margin:0 10 0 0px; padding: 0px;">
        ...
        <li class="active">Pre Cetak</li>
      </ol>

      <div class="row">
        <div class="col-sm-12">
          <div class="card-box table-responsive">
            <h4 class="m-t-0 header-title"><b>TABEL LAPORAN DIVISI PRE CETAK</b></h4><br>
            ...
            <!-- DETAIL LAPORAN -->
              ...
              ?>
                <div id="detail-<?php echo $v->id_pre_cetak; ?>" class="modal fade bs-example-modal-lg-<?php echo $v->id_pre_cetak; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                      <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h4 class="modal-title" id="myLargeModalLabel"><b>Laporan Divisi Pre Cetak</b></h4>
                      </div>
                              ...
                              <table class="table m-0">
                                <thead>
                                  <tr>
                                    ...
                                    <th><center>Sumber Berita</center></th>
                                ...
                                <tbody>
                                  <?php
                                  $no = 1;
                                  foreach ($data_pre_cetak_all as $x) {
                                    if (($v->tanggal == $x->tanggal) && ($v->nama_koran == $x->nama_koran)) {
                                      $waktu_mulai = substr($x->jam_masuk_pre_cetak, 0, 5);
                                      $waktu_selesai = substr($x->jam_selesai_pre_cetak, 0, 5);
                                  ?>
                                  <tr>
            ...
            <table id="datatable" class="table table-striped table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <center>
                    <a href="" title="Detail Laporan" data-toggle="modal" data-target=".bs-example-modal-lg-<?php echo $v->id_pre_cetak ?>"><i style="font-size: 20px;" class=" md-remove-red-eye"></i></a>
                    </center>
                  </td>
                </tr>
                <?php
