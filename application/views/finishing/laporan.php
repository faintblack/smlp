        ...
        <div class="col-sm-12">
          <div class="card-box table-responsive">
            ...
            <!-- DETAIL LAPORAN -->
	            ...
	            ?>
		            <div id="detail-finishing-<?php echo $v->id_finishing; ?>" class="modal fade bs-example-modal-lg-<?php echo $v->id_finishing; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
              ...
              <tbody>
                  ...
                  <td>
                  	...
                  	<a href="" title="Detail Laporan" data-toggle="modal" data-target=".bs-example-modal-lg-<?php echo $v->id_finishing ?>"><i style="font-size: 20px;" class=" md-remove-red-eye"></i></a>
                  		&nbsp;&nbsp;&nbsp;
                  	<a title="finishing Laporan" href="" onclick="printFinishing('<?php echo $v->id_finishing; ?>')"><i style="font-size: 20px;" class="md-print"></i></a>
                  	</center>
                  </td>
                </tr>
              	<?php
...
<?php
	if ($this->session->flashdata('tambah_prefinishing_1')) {
		echo "<script>alert('".$this->session->flashdata('tambah_prefinishing_1')."');</script>";
	} else if ($this->session->flashdata('tambah_prefinishing_0')) {
		echo "<script>alert('".$this->session->flashdata('tambah_prefinishing_0')."');</script>";
	} else if ($this->session->flashdata('edit_pre_finishing_1')) {
		echo "<script>alert('".$this->session->flashdata('edit_pre_finishing_1')."');</script>";
	} else if ($this->session->flashdata('edit_pre_finishing_0')) {
		echo "<script>alert('".$this->session->flashdata('edit_pre_finishing_0')."');</script>";
	} else if ($this->session->flashdata('tambah_prefinishing_2')) {
		echo "<script>alert('".$this->session->flashdata('tambah_prefinishing_2')."');</script>";
	} else if ($this->session->flashdata('edit_pre_finishing_2')) {
		echo "<script>alert('".$this->session->flashdata('edit_pre_finishing_2')."');</script>";
	}
?>