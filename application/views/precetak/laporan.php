        ...
        <div class="col-sm-12">
          <div class="card-box table-responsive">
            ...
            <!-- DETAIL LAPORAN -->
	            ...
	            ?>
		            <div id="detail-<?php echo $v->id_percetakan; ?>" class="modal fade bs-example-modal-lg-<?php echo $v->id_percetakan; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
              ...
              <tbody>
                  ...
                  <td>
                  	...
                  	<a href="" title="Detail Laporan" data-toggle="modal" data-target=".bs-example-modal-lg-<?php echo $v->id_percetakan; ?>"><i style="font-size: 20px;" class=" md-remove-red-eye"></i></a>
                  		&nbsp;&nbsp;&nbsp;
                  	<a title="Cetak Laporan" href="" onclick="printPreCetak('<?php echo $v->id_percetakan; ?>')"><i style="font-size: 20px;" class="md-print"></i></a>
                  	</center>
                  </td>
                </tr>
              	<?php
